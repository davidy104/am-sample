package com.aucklandmuseum.image.v2.config;
...
import com.aucklandmuseum.image.v2.route.ImageS3ProcessRoute;

@Configuration
@ComponentScan(basePackages = "com.aucklandmuseum.image.v2")
